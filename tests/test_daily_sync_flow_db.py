"""
Tests for daily_sync.flow_db module.
    ...
    def test_merges_duplicates_within_tolerance(self):
        ...
        sessions = [
            ...
            },
            {
                "pk": 2,
                "pks": [2],
                "start": base_start + datetime.timedelta(seconds=30),  # 30s later, within tolerance
    ...
    def test_completed_session_anchors_times(self):
        ...
        sessions = [
            ...
            },
            {
                "pk": 2,
                "pks": [2],
                "start": base_start + datetime.timedelta(seconds=10),  # Within tolerance
                "end": datetime.datetime(2025, 12, 27, 10, 0),
                "phase": "flow",
                "title": "Work",
